...
default_template = "$performer - $title - $date [$height][$video_codec]"
...
LIBRARY_PATH = os.environ['LIBRARY_SCENES']

# change to True to use the default template if no specific tag/studio is found
p_use_default_template = True
# default template, adjust as needed
p_default_template = fr"{LIBRARY_PATH}/$performer - $title - $date"
...
associated_extension = [ "srt", "vtt", "funscript", "trickplay", "svg", "jpg", "jpeg", "png", "nfo" ]
...
performer_ignoreGender = [ "MALE", "TRANSGENDER_MALE", "TRANSGENDER_FEMALE", "INTERSEX", "NON_BINARY", "UNDEFINED" ]
